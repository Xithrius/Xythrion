...
# Yoinked from https://gist.github.com/Soheab/f226fc06a3468af01ea3168c95b30af8
...
class ButtonPaginator(Generic[PageT_co], discord.ui.View):
    ...
    def format_page(self, page: PageT_co | Sequence[PageT_co]) -> PageT_co | Sequence[PageT_co]:
        return page
    ...
    async def start(
        self, obj: Interaction | Messageable, **send_kwargs: Any,
